...
- Current commercial truth: the paid Pilot/Setup package is retired. Owner decision FM-DEC-014 approves three permanent public offers: `Starter Flex = 990 € one-time setup + 312 €/month` and `Starter 12 Monate = 0 € setup + 312 €/month with a 12-month minimum term, then monthly renewal`. Daily = 0 EUR setup + 1 EUR/day, daily cancellable, no referral discount. Reuse its existing internal_daily_test engine/Price for compatibility; the former 24-hour public beta restriction no longer controls the permanent catalog. FM-DEC-020 adds a persistent Platform Admin ON/OFF switch in `/admin/settings` for the public Daily offer and new admission; OFF applies across public and account package selection without changing existing subscriptions, customer access or contract text. Public account selection does not bypass current consent, tax, Workspace or billing readiness. Core includes one creator/workspace, KI Standard and 10 connections. Each additional five connections are planned at +49 €/month. KI Plus is +100 €/month; KI Ultra is +200 €/month. Agency remains Coming Soon: self-paying creators are managed without double billing; agency-paid creators use a 312 €/month Hub plus 0/5/10/15 % volume tiers. Referral applies only to Core and cannot be combined with an Agency volume discount. Do not reintroduce the old Pilot or 299 €/month pricing.
