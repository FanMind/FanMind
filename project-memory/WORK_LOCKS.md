...
- Branch/PR: `mobile/app-store-connect-worksheet-20260830` (PR pending); dual-store PR #1031, prior handoff PR #1030 and Store implementation PR #1028 are merged.
