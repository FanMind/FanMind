...
- Current checkpoint: draft PR #1121 preserves source/UI clarification and provider evidence; real connections remain blocked by Workspace admission and Instagram configuration. Bernd explicitly approved the named Meta use case; one subsequent save was again rejected by automatic approval review for its bundled content-publishing capability. That broader acknowledgment remains the specific review boundary. The generated-status CI drift is corrected in the follow-up. Keep this lock tied to that continuation; no provider or billing acceptance claimed.
