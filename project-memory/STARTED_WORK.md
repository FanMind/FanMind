...
- Still open: the complete private receipt-bound 19-check Android runbook/validator, Supabase redirect/recovery and applicable Push/Store evidence remain open. iOS/TestFlight remains Phase 8 and does not block the current through-Phase-7 finishline.
