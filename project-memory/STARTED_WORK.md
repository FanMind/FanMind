...
- Exact next step: local controller PR #1082 is exact-head accepted and merged as `205febde8ef62f632e488337a6e887d1abb532f9`. A real external Storage transition remains deferred under `FM-RST-OWNER-007`; never rerun the database Restore and never infer `STORAGE_RESTORED` from the synthetic proof.
