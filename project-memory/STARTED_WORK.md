...
- Current repository continuation: FM-EV-034 adds a single machine-checked App Store Connect worksheet covering 33 first-release portal fields: thirteen technical values are ready, twelve need owner/legal/account decisions and eight remain Phase-8 binary/device controls. Store/Mobile/root/full Operations and Project Memory checks pass locally; exact-head PR acceptance is pending. No Mobile build, TestFlight, portal write or Android-AAB replacement is included.
