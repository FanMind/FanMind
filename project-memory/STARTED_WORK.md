...
- Exact next step: FM-CR-043 source hotfix -> current-head CI/review -> normal Production deploy/version -> owner re-login with the same already-granted account and verify Dashboard/Fans/Inbox/Follow-ups. Do not repeat registration or grant. No further real grants until the missing synthetic lifecycle acceptance is completed.
