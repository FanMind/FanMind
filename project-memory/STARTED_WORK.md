...
- Exact next step: PR #1082 merged as `205febde8ef62f632e488337a6e887d1abb532f9`, but delayed review findings invalidated its acceptance. PR #1085 is the active repository-only repair; exact-head review through `bf0375a91dbc95949e57a28b2f61aa549eb99d33` required pre-write invocation reservation, ownership-bound replacement/removal, foreign-final preservation and same-handle filesystem validation. Those paths are now implemented locally; renew exact-head CI/review before acceptance. A real external Storage transition remains deferred under `FM-RST-OWNER-007`; never rerun the database Restore and never infer `STORAGE_RESTORED` from the synthetic proof.
