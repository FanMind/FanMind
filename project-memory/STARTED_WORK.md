...
- Exact next step: PR #1082 merged as `205febde8ef62f632e488337a6e887d1abb532f9`, but delayed review findings invalidated its acceptance. PR #1085 is the active repository-only repair; exact-head review through `638f52ba321b4f2d57834cbe101af194f3740e94` additionally required lock-held final promotion, atomic finalizing cleanup and matching rollback state in both pending/reservation receipts. The lock receipt now becomes the terminal receipt through one atomic rename after marker cleanup, and both rollback receipts agree; renew exact-head CI/review before acceptance. A real external Storage transition remains deferred under `FM-RST-OWNER-007`; never rerun the database Restore and never infer `STORAGE_RESTORED` from the synthetic proof.
