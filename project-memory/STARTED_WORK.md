...
- Exact next step: implement the bounded SELECT-only catalog export and offline pinned-reference classifier, then exact source tests, independent review and normal PR completion.
- Task: FM-CREATOR-001
