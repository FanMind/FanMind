...
- Exact next step: publish this bounded package and obtain exact-head CI/CodeQL/review; then design the separate checksum-pinned atomic ledger package without applying it.
