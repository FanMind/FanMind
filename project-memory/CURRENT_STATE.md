...
- FM-DEC-015 / FM-CR-029 supersedes earlier sequencing below: FM-CREATOR-001 and selected Social/human-AI-handoff engineering are resumed now, before Android completion. Each Creator receives an independent FanMind account/Workspace with exactly one Creator profile. Team/roles/auditable approvals and multi-workspace management remain later.
- Existing CRM/Meta foundations are reused. Current scope: structured profile/voice/playbook editor, automatic Creator context in the existing reply pipeline, confirmed commercial-data entry with evidence, safe null/stale commercial scores, AFTERCARE/offer policy, manual OnlyFans handoff and controlled schema preparation. Local Operations: 1,269 passed, one PG17-only test skipped locally; actual API tests include foreign IDs, stale profile discard, provenance, origin and no-write denial. Actual schema rollout, provider/legal acceptance and real voice quality remain separate; no whole gate is accepted.
- Paid activation stays DEFERRED_BY_OWNER until actual tax/UID facts are available. PR #1098's displayed-consent fix is already PRODUCTION_CONFIRMED at 22017b3a8927b47c8ca67447f00e596d21cb9ae7, with successful Deploy 34510228167, Audit 34510392821 and Readiness 34510392800. Its final receipt releases LOCK-FM-BILL-003-20260910; do not repeat publication or tax questions during deferral.
- Restore DB_POSTCHECKED, separate Staging, existing signed Android/Play Alpha and completed Security controls stay accepted at their recorded scope. Sales_ready=false; real Storage/Restore closeout, full registration/Billing, provider/Meta and Android/Push/Play acceptance remain visible.
- Current work lock: LOCK-FM-CREATOR-SOCIAL-20260910. Complete the scoped implementation and exact-head verification/review/publication; Android follows these increments.
...
1. **FM-CREATOR-001:** current priority by FM-DEC-015: complete current-head Creator/Social source validation and publication, then protected Staging runtime and voice quality. One Creator per independent account/Workspace; full chat-learning remains next. Reuse existing Facebook/Instagram and manual OnlyFans handoff; actual provider/legal acceptance stays open.
