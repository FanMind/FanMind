...
2. **FM-CREATOR-001:** #1175 source reconciliation is consumed. Creator remains executable in the catalog, but the bounded manager-correction worker is currently active and deliberately serializes new product work until its own CI/review/merge/release completes. Do not fabricate capacity or recreate #1175; recompute the manager immediately after this governance scope closes.
