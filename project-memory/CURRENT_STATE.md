...
3. **FM-MOB-001:** use the already verified signed Android preview from protected run `33260695232` for owner real-device confirmation; keep redirect/recovery and applicable Push/Store acceptance open. Do not queue another build solely for confirmation. iOS/TestFlight is Phase 8 and must not be started during the current finishline.
