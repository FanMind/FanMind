...
- This is repository verification for one PR, not merge or runtime acceptance. The broad Creator action must not be reactivated; exact-head CI, independent review and normal merge remain next.
