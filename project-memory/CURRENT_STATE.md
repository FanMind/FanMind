Warning: truncated output (original token count: 28628)
...
- This supersedes older pending/failed foundation checkpoints only. Do not reapply SQL or rerun the accepted foundation merely for a new reader commit. Canonical readers now point to the actual source/target receipt. No executable behavior changes in this closeout. EV-CREATOR-STAGING-FOUNDATION-20260911 records the 24-hour mutable evidence TTL and revalidation trigg…8628 tokens truncated…ed-language check on the identical feature name. English copy is corrected without changing the guard; both sets of additive Project Memory records are preserved while merging current main.
