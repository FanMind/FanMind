...
3. **FM-MOB-001:** preserve the accepted FM-MOB-004 Android device result for exact merge `6a2f5b6c9bac1607ecc2ccae11c6ade3cb418522`; keep redirect/recovery and applicable Push/Store acceptance open. Do not queue another build merely to repeat acceptance. iOS/TestFlight is Phase 8 and must not be started during the current finishline.
