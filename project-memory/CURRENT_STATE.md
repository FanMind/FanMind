...
3. **FM-MOB-001:** use the latest verified FM-MOB-004 signed Android preview from protected run `33298699290` / job `99222705186`, exact merge `6a2f5b6c9bac1607ecc2ccae11c6ade3cb418522`, for owner real-device confirmation; keep redirect/recovery and applicable Push/Store acceptance open. Do not queue another build solely for confirmation. iOS/TestFlight is Phase 8 and must not be started during the current finishline.
