...
- Full local suite after correction: 1,446 passed, one skipped, zero failures; normal build, type/lint and truth checks pass. Earlier exact-head 40ed67a4 CI was all green including 46 public desktop/mobile cases. The correction requires fresh final-head checks/review before normal publication.
