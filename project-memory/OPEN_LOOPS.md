...
- Source #1099-#1108 and #1140 are published. Creator schema/upgrade/JWT/revision/PDF foundation acceptance 34629009649 passed. Contact/account deletion plus complete disclosure are implemented in the current bounded PR but not yet merged/deployed; actual deployed flag, enabled runtime UI, confirmed-chat persistence and real quality/provider acceptance remain open.
