...
- Source #1099-#1108 and #1140 are published. PR #1143 merged as `027d5a21ac41daae0331a0af2f9685d3729b2039`; its original three findings were corrected by merged #1144 / `93027f7cf04d7bff5a03b3ec3a3e39f0cc5fd334`. #1144 then retained a new post-merge P1/P2/P2 set: the Contact-delete caller must remain usable before its controlled RPC is installed without bypassing Meta queue dependencies, null-Workspace deletion requests must remain valid only for no-Workspace accounts, and interrupted deletion resume must still verify a request Workspace that was actually deleted while excluding a surviving transferred Workspace. Delete/Privacy/Disclosure remains open until this bounded follow-up passes current-head convergence and merges. Actual deployed flag, enabled runtime UI, confirmed-chat persistence and real quality/provider acceptance remain separate.
