...
- Reference: Meta content run `33007156552`, job `98303773974`; conversation-continuation run `33007311870`, job `98304322162`; catch-up-queue run `33007481167`, job `98304886826`; `META_TECHNICAL_READONLY_RECONCILIATION_2026-08-26.md`; evidence PR #1014; issue #714.
