...
- Reference: `trigger-function-hardening-production-control.yml` run `32997946812`, job `98271985321`; deploy run `32996396550`, job `98266724400`; PR #1008; checksum-pinned Production runner/log verifier; fresh post-run Production security advisors
