...
- Freshness boundary: mutable issue-state snapshot `EV-LEGACY-ISSUE-SNAPSHOT-20260830` records the exact observation time and requires revalidation on any issue body/state change, before relying on the reconciliation, or before reopening reconciled work.
