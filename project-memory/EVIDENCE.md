...
- Device acceptance: on 2026-08-30 the owner installed and inspected the superseding exact FM-MOB-004 Android build on a real device and confirmed the current Mobile result as finished. That accepted build includes and confirms the FM-MOB-003 behaviors.
...
- Type: implementation diff + repeated exact-head review/countercheck + complete repository/native verification + protected signed Android internal build + owner real-device acceptance
...
- Device acceptance: on 2026-08-30 the owner installed and inspected the exact-merge Android Preview on a real device and confirmed the current Mobile result as finished. Recovery redirect and applicable Push/Store acceptance remain separately open under FM-MOB-001 and do not reopen FM-MOB-004.
