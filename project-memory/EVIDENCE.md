...
- Date: 2026-08-30
- Target: repository-only legacy issue reconciliation on `ops/legacy-issue-reconciliation-20260830`; later GitHub issue metadata only after exact-head merge; no runtime/provider/database/billing/Mobile build target
...
- Limitations: exact-head PR gates, merge and post-merge GitHub issue metadata reconciliation remain pending. The retained #642/#643 gates are not accepted by this repository change.
