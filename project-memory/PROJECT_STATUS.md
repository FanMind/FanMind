...
- The protected synthetic Owner-ID contains one trailing control character. Exact run `36250479400` still received it, and a later read-only protected-editor inspection at `2026-09-26T15:08:32Z` reported `length=37`, `trimmedLength=36`, `hasOuterWhitespace=true`. The earlier correction/readback claim is contradicted and not consumed; no credentials, accounts or capability changed.
