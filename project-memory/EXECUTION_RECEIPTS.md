...
- Status: COUNTERCHECKED_LOCAL_FIX; exact-head PR CI/review remained required at this historical checkpoint before resolving `CTR-FM-021` and releasing the repair lock.
