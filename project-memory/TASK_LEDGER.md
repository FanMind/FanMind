...
- Exact next step: #1114 is reviewed, deployed and runtime-confirmed at 41d25478 (final receipt 5652605280). Correct the demonstrated rejection of the official nginx executable condition, then complete current-head review/CI/normal rollout, runner mode/registration and PM2 PATH diagnostics, independent reference and installed boot proof. Owner admin access and retained PM2 0600 are confirmed; both co-located runners need fresh idle checks before the requested controlled reboot. Overall boot readiness remains false.
