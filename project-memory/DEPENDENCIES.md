...
- The earlier database-backup blocker is closed by #1111 final receipt 5644711203 and the September 12 full audit. The acceptance rules and historical failure records remain unchanged. Controlled reboot and remaining Restore are separate.
...
- Rule: remaining blockers are dispatch-time current-main/target binding plus a separate explicit owner/protected authorization. God Mode merge never authorizes APPLY. ACCEPT remains a later separate protected step after successful apply/postflight evidence.
