...
- Later authorization comment `5385992305` and controller SHA-256 `45054c41143e33fce4406aea30478e43ed5280a36e1b339d0cc9c38df71ae946` were attempted on 2026-08-26. The controller stopped at its first SSH connection to `138.124.213.66:22` after only the accepted-readiness/main-drift local markers. No JIT, environment approval, workflow dispatch, PostgreSQL connection or write occurred.
- Highest accepted progression remains `TARGET_COMPATIBLE`; current side state is `RECONCILIATION_REQUIRED` for SSH reachability/allowlist evidence. Automatic retry and reuse of that controller/authorization are forbidden. After connectivity is reconciled, require a new exact R4 authorization and fresh controller.
