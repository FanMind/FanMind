...
- Mobile boundary: the complete private receipt-bound 19-check Android runbook/validator, Supabase recovery redirect and applicable Push/Store controls remain open under FM-MOB-001. Per FM-CR-004/FM-DEC-009, iOS/TestFlight is Phase 8 and does not block the current through-Phase-7 Mobile finishline. A newly observed defect requires a new bounded task; it does not authorize schema/RLS changes, provider activation or duplicate demo data.
...
- User input still required: `FM-RST-OWNER-005`/`006`, `FM-SEC-OWNER-001`/`002`, the complete private Android runbook/validator plus separate Mobile recovery/Push/Store controls under FM-MOB-001, AI decisions/protected lifecycle under `FM-AI-OWNER-001`/`002`, and external Meta acceptance under `FM-META-OWNER-001`. The bounded real-device UI/runtime scope for FM-MOB-003/FM-MOB-004 is complete; iOS/TestFlight is intentionally deferred to Phase 8. Routine repository analysis/fixes/PR/green merge and evidence closeout remain standing-authorized.
