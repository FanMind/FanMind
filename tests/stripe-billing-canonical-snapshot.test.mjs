...
const subscription=()=>({id:'sub_base',object:'subscription',customer:'cus_owner',livemode:false,status:'active',metadata:{workspace_id:target.workspaceId},pending_update:null,pause_collection:null,cancel_at:null,canceled_at:null,ended_at:null,cancel_at_period_end:false,items:{object:'list',has_more:false,data:[{id:'si_base',subscription:'sub_base',quantity:1,current_period_start:1788624000,current_period_end:1791216000,price:{id:'price_base',object:'price',livemode:false}}]},latest_invoice:{object:'invoice',id:'in_paid',customer:'cus_owner',livemode:false,status:'paid',amount_remaining:0,amount_due:31200,amount_paid:31200,created:1788624000,attempt_count:1,next_payment_attempt:null,hosted_invoice_url:null,invoice_pdf:null,parent:{subscription_details:{subscription:'sub_base'}}},lastResponse:{requestId:'req_snapshot'}});
