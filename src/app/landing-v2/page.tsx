...
const pricingPlans = [
  ...
  },
  {
    icon: "◷",
    name: "Daily",
    eyebrow: "Täglich kündbar",
    audience: "Für einen flexiblen Einstieg mit täglicher Abrechnung.",
    pricePrefix: "",
    price: "0 € Setup + 1 €/Tag",
    cadence: "tägliche Abrechnung · täglich kündbar",
    cta: "Registrieren",
    href: "/register?plan=daily",
    tone: "purple",
    featured: false,
    status: "Registrierung offen",
    features: ["Keine Einrichtungsgebühr", "Täglich kündbar", "Kein Referral-Rabatt", "Zahlung separat nach Kontoerstellung", "Kein automatischer Versand"],
  },
  {
    icon: "↗",
    name: "Growth",
