        ...
        {registeredUsers.map((registeredUser) => {
          ...
          return <div className={`${styles.teamTableRow} ${controlledAccess ? styles.internalTestRow : ""}`} key={registeredUser.id}>
            ...
            <span className={styles.actions}>
              {!confirmed ? <span className={styles.muted}>Bestätigung erforderlich</span> : !workspace ? <form action={`/api/admin/billing/users/${registeredUser.id}/crm-access`} method="post"><input type="hidden" name="mode" value="permanent" /><button className={styles.buttonPrimary}>Dauerhaft kostenlos freigeben</button></form> : controlledAccess ? <>
