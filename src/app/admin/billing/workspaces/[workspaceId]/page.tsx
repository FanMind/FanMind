...
export default async function AdminBillingWorkspaceDetailPage({ params }: { params: Promise<{ workspaceId: string }> }) {
  ...
  const isAdminCrmAccess = isAdminCrmAccessWorkspace(workspace);
