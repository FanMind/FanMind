...
export const roadmapPhases: RoadmapPhase[] = [
...

  {
    ...
    items: [
      ...
      { label: "Instagram", state: "progress", status: "Anbindung und Abnahme in Arbeit" },
      { label: "WhatsApp", state: "planned", status: "Roadmap" },
      { label: "Technische & rechtliche Prüfung", state: "progress", status: "Provider-Freigaben weiterhin erforderlich" },
    ],
  },
...

  {
    ...
    status: "Android-Abschluss nach Creator- und Social-Ausbau",
    statusIcon: "◷",
    tone: "cyan",
    availability: "upcoming",
    items: [
...

  {
    ...
    items: [
      ...
      { label: "Creator-Profile & getrenntes Fanwissen", state: "progress", status: "Ein Creator · ein eigener Account und Workspace" },
      { label: "Eigene Creator-Stimmen & automatischer Creator-Kontext", state: "progress", status: "Strukturierte Profile · Umsetzung begonnen" },
      { label: "Sales Playbooks & Gesprächssteuerung", state: "progress", status: "Angebotsregeln und Gesprächszustände in Arbeit" },
      { label: "Kaufdaten & Lernen aus bestätigten Chats", state: "partial", status: "Datenmodell begonnen · Lernschleife folgt" },
    ],
  },

  {
    ...
    items: [
      ...
      },
      {
        ...
        state: "progress",
        status: "Antwortentwürfe und manuelle Übergabe in Arbeit",
      },
      {
